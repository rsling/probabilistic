% !Rnw root = ../smil.Rnw
<<setupclit, cache=FALSE, echo=FALSE, include=FALSE, results='asis'>>=
...
\subsection{Distributional factors: Cliticised form vs. full form, \textit{n} vs. \textit{nen}}
...
\subsection{General distribution of abbreviated forms and full forms in the corpus}
...
\subsection{Study 1: Abbreviated forms as alternation in semi-spontaneous written language}
