<<setupmsrnscorpus, cache=FALSE, include=FALSE, results='asis'>>=
...
For the present study, I used the 21 billion token German \textit{Corpus from the Web} (COW) in its 2014 version DECOW14A (??TODO RS SCHAEFERBILDHAUER2012, and \citealp{Schaefer2015b}, as well as \citealp{BiemannEa2013}, and \citealp{SchaeferBildhauer2013alt}, for overviews of web corpora in general and the methodology of their construction).%
