...
\include{sections/1linkingelementsinprobabilisticmorphology}
\include{sections/2linkingelementsingerman}

<<child="sections/3data.Rnw">>=
@

<<child="sections/4corpusstudy.Rnw">>=
@

<<child="sections/5split100experiment.Rnw">>=
@
